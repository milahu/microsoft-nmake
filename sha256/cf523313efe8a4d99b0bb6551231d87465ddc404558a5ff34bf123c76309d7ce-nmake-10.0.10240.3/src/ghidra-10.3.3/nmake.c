...

{
  ...
  if (pwVar4 == (wint_t *)0x0) {
    ...
    if (iVar3 != 0) {
      ...
      FUN_140003898((ulonglong)DAT_140025c20,0x409,0x140012000,param_4);
    }
  ...
  do {
    ...
    if ((int)param_1 <= iVar11) {
      if ((DAT_140037094 == 3) && (uVar6 = FUN_140009aa8(), (char)uVar6 == '\0')) {
        ...
        FUN_140003898(0,0xfae,0x1400127e0,param_4);
      }
      bVar2 = FUN_140009a74();
      if (!bVar2) {
    ...
    if (((ulonglong)p_Var12 & 0x40) == 0) {
      ...
      if (((ulonglong)p_Var12 & 0x10) != 0) {
        if (cVar9 == (char)uVar4) {
          ...
          FUN_140003898(uVar7,0x409,0x140025c50,param_4);
        }
        goto LAB_14000c210;
      }
      ...
      if ((bVar1 & 0x20) != 0) {
        uVar7 = (ulonglong)DAT_140025c24;
        p_Var12 = (LPWIN32_FIND_DATAW)&DAT_140025c50;
        FUN_140003898(uVar7,(ulonglong)(bVar1 + 1000),0x140025c50,param_4);
        uVar6 = DAT_140015048;
      }
      DAT_140015048 = uVar6 - 1;
      uVar8 = (ulonglong)DAT_140015048;
