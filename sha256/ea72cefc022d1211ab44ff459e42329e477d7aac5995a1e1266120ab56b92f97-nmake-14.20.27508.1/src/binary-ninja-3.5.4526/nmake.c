int32_t __convention("regparm") sub_402acc(char* arg1)
{
    ...
    *arg1 = (*arg1 + arg1);
    *arg1 = (*arg1 + arg1);
    sub_40ebf9(&data_4226c0, &data_4226bc, nullptr, nullptr, 0, 0, 0);
    int32_t eax = sub_40e917(&data_4226c0);
    data_4226b8 = eax;
    return eax;
}
...
void sub_405532()
{
    ...
    void* const var_4 = u"14.20.27508.1";
    data_422ee0 = 1;
    sub_4054a3(0x18);
    sub_4054a3(0x19);
    /* tailcall */
...
int32_t sub_40b971(int32_t arg1, int32_t arg2) __noreturn
{
    ...
    int32_t var_8_2 = (0x4115a0 ^ __security_cookie_1);
...
void* const sub_40be0c()
{
    ...
    sub_403430(sub_40e917(u"_NMAKE_VER"), sub_40e917(u"14.20.27508.1"), 2);
...
int32_t sub_410838(int32_t arg1 @ esi)
{
    ...
    int32_t var_30 = arg1;
    uint32_t __security_cookie_1 = __security_cookie;
    int32_t var_8_3 = (0x4115c0 ^ __security_cookie_1);
    var_4;
...
int32_t ___scrt_initialize_onexit_tables(int32_t arg1)
{
    ...
    {
        int32_t esi_2 = ((RORD(0xffffffff, (0x20 - (__security_cookie & 0x1f)))) ^ __security_cookie);
        data_412448 = esi_2;
        data_41244c = esi_2;
        data_412450 = esi_2;
        data_412454 = esi_2;
    ...
    if (((eax_1 == 0 || (eax_1 != 0 && arg1 != 0)) || ((eax_1 != 0 && arg1 == 0) && eax_2 == 0)))
    {
        data_412445 = 1;
        eax_2 = 1;
    }
...
void* ___scrt_is_nonwritable_in_current_image(int32_t arg1)
{
    ...
    int32_t var_8 = 0x4115e0;
    enum _EXCEPTION_DISPOSITION (* var_10)(int32_t* arg1, struct _EXCEPTION_REGISTRATION_RECORD* arg2, struct _CONTEXT* arg3, int32_t arg4) = __except_handler4;
    int32_t* fsbase;
    int32_t var_14 = *fsbase;
    uint32_t __security_cookie_1 = __security_cookie;
    int32_t var_8_4 = (0x4115e0 ^ __security_cookie_1);
    var_4;
    int32_t var_2c = (__security_cookie_1 ^ &var_4);
    int32_t* var_1c = &var_2c;
    void* const var_30_1 = &data_410d56;
...
int32_t sub_410daf(void* arg1 @ ebp)
{
    int32_t ecx;
...
int32_t sub_410f0b() __pure
{
    return 0;
}

int32_t sub_410f0e() __pure
{
    return 1;
}

int32_t sub_410f12() __pure
{
    return 0x4000;
}
...
int32_t sub_410f71() __pure
{
    return 0x4372e4;
}

int32_t sub_410f77() __pure
{
    return 0x4372e0;
}
...
LPTOP_LEVEL_EXCEPTION_FILTER sub_4110df()
{
    return SetUnhandledExceptionFilter(sub_4110eb);
}

int32_t __stdcall sub_4110eb(int32_t* arg1)
{
    int32_t* eax_1 = *arg1;
...
int32_t __convention("regparm") sub_411546(void* arg1)
{
...
int32_t __convention("regparm") sub_4115b3(int32_t arg1)
{
