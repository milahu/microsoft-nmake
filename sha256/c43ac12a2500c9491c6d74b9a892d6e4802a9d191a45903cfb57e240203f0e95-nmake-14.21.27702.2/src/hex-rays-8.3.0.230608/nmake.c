...
int sub_405532()
{
  ...
  {
    byte_422EE0 = 1;
    sub_4054A3(0x18u, L"14.21.27702.2");
    sub_4054A3(0x19u);
    return sub_40CD86();
  }
  return result;
}
// 401638: using guessed type wchar_t a1421277022[14];
...
char *sub_40BE0C()
{
  ...
  v12 = (wchar_t *)sub_40E917((char *)L"14.21.27702.2");
...
// 410F25: using guessed type int __scrt_initialize_default_local_stdio_options(void);
...
// 411111: could not find valid save-restore pair for edi

//----- (0041113D) --------------------------------------------------------
void __cdecl sub_41113D()
{
  ;
}
// 41113D: could not find valid save-restore pair for edi
