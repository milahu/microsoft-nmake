...
int sub_405532()
{
  ...
  {
    byte_422EE0 = 1;
    sub_4054A3(0x18u, L"14.22.27905.0");
    sub_4054A3(0x19u);
    return sub_40CD65();
  }
  return result;
}
// 401638: using guessed type wchar_t a1422279050[14];
...
char *sub_40BDEB()
{
  ...
  v12 = (wchar_t *)sub_40E8FE((char *)L"14.22.27905.0");
...
// 4110F8: could not find valid save-restore pair for edi

//----- (00411124) --------------------------------------------------------
void __cdecl sub_411124()
{
  ;
}
// 411124: could not find valid save-restore pair for edi
...
// nfuncs=253 queued=188 decompiled=188 lumina nreq=0 worse=0 better=0
