...
# note: this is the second scrape, so we need to append to existing source.txt files
...
# TODO download torrent: 'Microsoft Visual Studio 2019 (v16.0.28729.10) RTM + Keys [AndroGalaxy].torrent'

mkdir mnt-iso
sudo mount -o loop "$HOME/Downloads/Microsoft Visual Studio 2019 (v16.0.28729.10) RTM [AndroGalaxy]/Microsoft Visual Studio 2019 (v16.0.28729.10) RTM [AndroGalaxy].iso" mnt-iso/
...
sed -i 's|^|microsoft-visualstudio-2019-16.0.28729.10-torrent |' */source.txt
